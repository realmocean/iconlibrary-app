...
if (shell.exec('node FilePackager.js ../../Applications/BPMGenesis/IconLibrary/dist/index.js ../../DemoApp/apps/IconLibrary.app').code !== 0) {
    shell.echo('Build failed');
    shell.exit(1);
}
shell.echo('App file done.');

shell.cp('-Rf', '../../DemoApp/apps/IconLibrary.app', '../../pythonProjects/bpmgenesis/src/portal/static/applications/IconLibrary.app');
shell.echo('App file done.');
...
const result = appStoreInfo.apps.find(item => item.id === 'IconLibrary');
